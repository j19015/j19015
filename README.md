...
静岡県浜松市からフルリモートで働く Web エンジニアです。**React / Next.js / TypeScript を中心にしたフロントエンド開発** を主戦場にしつつ、時期やプロダクトによっては **Node.js / Python(FastAPI) / C#(.NET) のバックエンド API** や、**AWS / Azure のクラウド構築** 側に寄って動いてきました。
...
- [【設計】月次締めを skill にする — 定型作業を「一言」に畳む設計](https://kt-tech.blog/blogs/monthly-close-skill-design)
<!-- BLOG-POST-LIST:END -->
